...
void avcodec_free_context(AVCodecContext **avctx)
{
    ...
    av_freep(&pavctx->extradata);
    av_freep(&pavctx->subtitle_header);
    av_freep(&pavctx->intra_matrix);
    av_freep(&pavctx->inter_matrix);
    av_freep(&pavctx->rc_override);
    av_channel_layout_uninit(&pavctx->ch_layout);
